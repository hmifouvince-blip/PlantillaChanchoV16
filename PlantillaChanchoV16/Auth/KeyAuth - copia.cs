...
namespace KeyAuthCopy
{
    public class api
    {
        ...
        /// </summary>
        /// 
        [DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof(response_structure))]
        [DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof(user_data_structure))]
        [DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof(app_data_structure))]
        public void init()
        {
        ...
        private void load_user_data(user_data_structure data)
        {
            ...
            user_data.subscriptions = data.subscriptions?.Select(s => new Data
            {
